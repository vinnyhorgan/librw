...
| 2026-04-25 | Examples | Added visible GLFW examples under `examples/`: `city_night`, `immediate_playground`, and `skin_dancer`; added `make examples`, smoke-run support via `RW_EXAMPLE_FRAMES`, and `examples/README.md`; strict `make test` passes |
